    ...
    <div>
      <Container id="cssToContainer">
        <Row className="justify-content-center">
          <Col className="card-box" md={4} sm={6}>
            <div id="card">
              <div>
                <div id="divImage">
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr className="cssToRow">
                        ...
                        <td className="cssToTableDataText">
                          info@punedreams.com
                        </td>
                      </tr>
                      <tr className="cssToRow">
                      ...
                      <tr className="cssToRow">
                        ...
                        <td className="cssToTableDataText ">
                          211,Paras Chambers,Above BOI, Near Laxminarayan
                          Theatre, Pune 411009
                        </td>
                      </tr>
                    </tbody>
              ...
              <div id="cssToThirdDiv" ref={scrollToElementRef}>
                ...
                <form>
                  ...
                  <br></br>
                  <input type="tel" placeholder="Enter Mobile"></input>
                  <br></br>
                  <input type="email" placeholder="Enter Email"></input>
                  <br></br>
                  <div className="input">
                    <input
                      className="cssToInput"
                      type="text"
              ...
              <div id="cssToReference">
                <p>
                  ...
                  <a id="cssToAnchor" href="https://www.cardmonk.com/">
